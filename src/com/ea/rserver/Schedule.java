...
public class Schedule {
	...
	/** the path in git to the task's base directory, starting with //GAI.. */
	 ...
	 */
	public Schedule(String taskName, String gitPath, String rScript, String owner, boolean emailOnSuccess, String params, boolean shinyApp, String jobId) {
		this();
	...
	public static void main(String[] args) { 
		System.out.println(parseSchedule("EmailTest,/tasks/EmailTest,sendmail.r,Now,, User@YourDomain.com, true,,false", true)); 
		System.out.println(parseSchedule("EmailTest,/tasks/EmailTest,sendmail.r,Now,, User@YourDomain.com, true,,false", false)); 
		System.out.println(parseSchedule("EmailTest,/tasks/EmailTest,sendmail.r,Hourly,19:35, User@YourDomain.com, true,,false", true)); 
		System.out.println(parseSchedule("EmailTest,/tasks/EmailTest,sendmail.r,Daily,11:00, User@YourDomain.com, true,,false", true)); 
		System.out.println(parseSchedule("EmailTest,/tasks/EmailTest,sendmail.r,Weekly,Sun 18:00, User@YourDomain.com, false,,false", true)); 
		System.out.println(parseSchedule("EmailTest,/tasks/EmailTest,sendmail.r,Monthly,24 11:31, User@YourDomain.com, true,,false", true)); 
		System.out.println(parseSchedule("EmailTest,/tasks/EmailTest,sendmail.r,Never,, User@YourDomain.com, true,,false", true)); 
	} 	
